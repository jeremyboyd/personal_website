...
```{r results, echo = FALSE, dev = "svg", out.width = "700", fig.cap = "Probability of cutting as a function of vehicle value and traffic. Lines represent predicted means. Shading represents the 95% credible interval."}
