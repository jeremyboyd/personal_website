...
# If I make any font changes in ggplot figures then they this file has to be
# re-knit before they show up on the published site.
...
- Less able to handle heavy traffic situations, so wealth effect is limited to heavy traffic.
- Alternatively, if they're cutting under light traffic circumstances then the idea that there's accidental cutting due to attentional differences is undermined. In this case the data would be more consistent with cutting due to ethics.
...
Bayesian hierarchical logistic regression was used to model the relationship between vehicle value and cutting.[^16]^,^[^17]^,^[^18] The clustering of datapoints by coder and intersection was taken into account by modeling coder and intersection as random effects with the maximal random effects structure.[^19] The main predictor variables of interest were vehicle value, traffic, and their interaction. Covariates included driver sex, driver age, and time of day.
...
```{r results, echo = FALSE, dev = "svg", out.width = "700", fig.cap = "Probability of cutting as a function of vehicle value and traffic. Lines represent predicted means. Lighter and darker shading represents the 95% and 88% credible intervals, respectively."}
