...
```{r results, echo = FALSE, dev = "svg", out.width = "700", fig.cap = "Probability of cutting as a function of vehicle value and traffic. Lines represent predicted means. Lighter and darker shading represents the 95% and 80% credible intervals, respectively."}
