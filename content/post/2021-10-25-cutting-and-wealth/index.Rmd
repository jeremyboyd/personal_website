...
categories: []
tags: ["social class", "unethical behavior", "driving", "attention", "Bayesian models", "hierarchical models"]
summary: ''
authors: [admin]
...
```{r results, echo = FALSE, dev = "svg", out.width = "700", fig.cap = "Probability of cutting as a function of vehicle value and traffic. Lines represent predicted means. Shading shows 95% credible intervals."}
